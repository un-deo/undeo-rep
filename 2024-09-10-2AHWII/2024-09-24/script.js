//HIer ist alles auf englisch weil ich beim programmieren enlglisch lieber habe (vor allem in den Ferien)
...
//Button dials add text to the input field
...
//checks if the number is part of the product list
enter.addEventListener("click", function () {
  ...
  //turns off the number buttons and asks how you want to pay the given price
  ...
  if (disablebuttons == true) {
    ...
    //adds an input where you enter the "payed amount" and then checksif you have insertet sufficient money
...
//this I did for Fun
//here depending on what button you press on the keyboard the backgroundcolor changes
